...
using LOopOop.Models.TokenAuth;
...
{
    public abstract class LOopOopWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LOopOopWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LOopOopWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LOopOopDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LOopOopDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LOopOopDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LOopOopDbContext, Task<T>> func)
        {
            T result;
